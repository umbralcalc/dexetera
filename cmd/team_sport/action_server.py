...
class TeamSportActionTaker(ActionTaker):
    ...
    def take_next_action(
        ...
        """
        Make substitution decisions based on team stamina.
        ...
        if "team_a_stamina" in states and "team_b_stamina" in states:
            ...
            # Strategy: If our stamina drops below 50% and we haven't substituted recently,
            # make a substitution to bring stamina back up
